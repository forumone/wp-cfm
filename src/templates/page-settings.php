...
<script src="<?php echo WCD_URL; ?>/assets/js/admin.js"></script>
<script src="<?php echo WCD_URL; ?>/assets/js/multiselect/jquery.multiselect.js"></script>
<script src="<?php echo WCD_URL; ?>/assets/js/pretty-text-diff/diff_match_patch.js"></script>
<script src="<?php echo WCD_URL; ?>/assets/js/pretty-text-diff/jquery.pretty-text-diff.js"></script>
<link href="<?php echo WCD_URL; ?>/assets/css/admin.css" rel="stylesheet">
